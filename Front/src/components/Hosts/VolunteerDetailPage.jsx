...
const categoryDescriptions = {
  "farms": `A Farm is a space dedicated to food production, where various agricultural products are grown and, in some cases, animals are raised. Farms promote a direct connection with the land, the natural cycle of the seasons, and manual labor. They are ideal places for those looking to learn about sustainable farming and eco-friendly practices.
...
`,
  "eco villages": `An Eco Village is a sustainable community where people share farmland or urban spaces with a focus on ecological living and harmony with nature. Those who choose this lifestyle seek a balance between environmental sustainability and a meaningful community.
...
`,
  "hostels": `A Hostel is a space designed for travelers looking for an affordable, social, and culturally enriching experience. More than just a place to stay, hostels foster connections between people from around the world, creating a global community through shared experiences and activities.
...
`,
  "camping sites": `A Camping Site is an outdoor space designed for travelers and nature lovers to enjoy an immersive experience in natural environments. Whether in the mountains, on the beach, or in the forest, camping offers the chance to disconnect from daily life and reconnect with nature.
...
`,
  "holistic centers": `A Holistic Center is a space dedicated to physical, mental, and spiritual well-being, where people can reconnect with themselves through healthy practices and alternative therapies. These centers blend ancient wisdom with modern techniques to promote a balanced and harmonious life.
            ...
            <div className="opportunities">
              {opportunities.map((item, index) => (
                <div key={index} className="opportunity-card">
                  ...
                  <h3>{item.category} - {apiData.countries[index].country}</h3>
